                            ...
                            <tbody id="tbody">
                                ...
                                <tr class="first">
                                    ...
                                    @if ($v['apply_status'] == 0)
                                        ...
                                        <li><a href="javascript:void(0)" class="check" serverId="{{$v['server_id']}}" carId="{{$v['car_id']}}" tel="{{$v['tel']}}" dep_time="{{$v['dep_time']}}" start="{{$v['start_city']}} | {{$v['start_dis']}} | {{$v['start_name']}}" applyId="{{$v['apply_id']}}" number="{{$v['car_type']}}">审核</a></li>
                                        </ul>
                                    @else
