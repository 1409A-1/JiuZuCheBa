        ...
        <ul class="top_menu">
            <li class="top_user">
                ...
                @if(!session()->has('user_name'))
                    ...
                    @else
                欢迎<font style="background: orange">{{ Session::get('user_name') }} </font>
            ...
            <li class="top_mobile">
                <a href="http://app.dafang24.com/" target="_blank" rel="nofollow">
                    ...
                    <div class="QR_code">
                        ...
                        <div class="QR_code_img"><img src="../resources/assets/hom e/public/code.png"></div>
                        <div class="QR_code_text">扫一扫，即刻体验</div>
                    </div>
                </a>
            </li>
            <li class="top_phone">13522226441</li>
        </ul>
    </div>
</div>
<!--菜单-->
