                        ...
                        @if(array_key_exists('all', $order))
                            @foreach($order['all'] as $k=>$v)
                                <div class="No">
                                    <ul class="order3">
                                        <li>
                                            <h5><a>订单号：</a>{{ $v['ord_sn'] }}&nbsp;&nbsp;&nbsp;&nbsp;@if($v['ord_type']==1)短租自驾@else长租服务@endif</h5>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <ul>
                                                    <li class="time">
                                                        <div>
                                                            取车时间<br>
                                                            {{ date('Y/m/d 10:00', $v['dep_time']) }}
                                                        </div>
                                                        <div>
                                                            还车时间<br>
                                                            {{ date('Y/m/d 10:00', $v['des_time']) }}
                                                        </div>
                                                    </li>
                                                    <li class="cen">{{ date('Y/m/d H:i:s', $v['apply_time']) }}</li>
                                                    <li class="state">
                                                        <a>
                                                           @if($v['apply_status']==0)
                                                               申请中
                                                    ...
                                                    <li class="operation">
                                                        @if($v['apply_status']==0)
                                                            <a href="{{ url('cancleLong') }}?ceoyg={{ $v['apply_id'] }}">取消申请</a>
                                                        @else
                                                            <a href="">查看</a>
                                                        @endif
                                                    </li>
