            ...
            <div class="user_info" style="display: block;">
                ...
                <div class="user_info1">
                    ...
                    <ul>
                        <li>
                            <a>*</a> 姓名：
                            <input value="<?php echo e($info['user_name']); ?>" id="name" style="margin-left:45px" type="text">
                        </li>
                        <li style="position:relative">
                            <a>*</a> 手机号：
                            <input value="<?php echo e($info['tel']); ?>" disabled id="phone" style="margin-left:58px;" type="text">
                        </li>
                        <li>
                            <a>&nbsp;</a> 紧急联系人：
