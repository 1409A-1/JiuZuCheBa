            ...
            $(document).delegate(".page","click",function(){
                ...
                $.get("adminlistpage/"+page,function(msg){
                    ...
                    for(i=0; i<msg.user.length; i++){
                        str+='<tr class="first"><td><input type="checkbox" /><div class="img"><img src="<?php echo e(asset('admin')); ?>/img/table-img.png" /></div><a href="#" class="name">'+msg.user[i].user_name+'</a></td><td class="description">******</td></tr>';
                    }
                    $("#tbody").empty();
                    $("#tbody").append(str);
