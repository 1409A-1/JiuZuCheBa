...
<ins id="qiao-wrap">
    <ins style="position: fixed; bottom: 0px;" class="qiao-flash-storage" id="qiao-flash-storage">
        ...
        <ul class="top_menu">
            <li class="top_user">
                <div class="yes_user">
                    <a href="" rel="nofollow" id="user_Name"><?php echo e(Session::get('user_name')); ?></a>
...
<div id="msgBox">
    ...
    <div class="list">
        ...
        <ul>
               <?php foreach($message as $k=>$v): ?>
                    <li id="cha">
                        <div><font style="color: #ff0000;font-size: 20px"><?php echo e($v['user_name']); ?> : </font></div>
                        <div class="content">
                            <div class="msgInfo"><?php echo e($v['message_con']); ?>。</div>
                            <div class="times"><span><?php echo e(date('Y/m/d H:i',$v['add_time'])); ?></span></div>
                        </div>
                    </li>
                <?php endforeach; ?>
        </ul>
    ...
    <script type="text/javascript">
        ...
        //ajax进行提交
                    $.get("<?php echo e(URL('message_add')); ?>", { name: name, con: con } );
        ...
        $(document).ready(function () { //本人习惯这样写了
            $(window).scroll(function () {
                ...
                if ((bot + $(window).scrollTop()) >= ($(document).height() - $(window).height())) {
                    ...
                    //我们需要去异步加载数据了
                    $.getJSON("<?php echo e(URL('message_down')); ?>", { page: y }, function (str) {
                       if(str){
