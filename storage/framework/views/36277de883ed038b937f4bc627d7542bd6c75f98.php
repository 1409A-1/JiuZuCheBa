...
<div class="orderInfoBox">
    <div class="left">
        <h4>确认订单信息<a href="<?php echo e(url('short')); ?>">重选车辆</a></h4>
        <!--基本信息-->
        <div class="carInfo">
            <div class="carInfoL">
                <img src="">
        ...
        <div class="invoice">
            ...
            <div class="invoiceInfo">
                ...
                <?php if(!empty($benefit)): ?>
                  <div id="test">
                    <?php foreach($benefit as $k=>$v): ?>
                        <input type="checkbox" stats="0" benefit_price="<?php echo e($v['ord_price']); ?>" benefit_name="<?php echo e($v['benefit_name']); ?>" num = <?php echo e($k); ?>>&nbsp;&nbsp;
                        <h3 style="display: inline"><?php echo e($v['ord_price'] .'    '.$v['benefit_name']); ?></h3><br><br>
                    <?php endforeach; ?>
                  </div>
                <?php else: ?>
                   暂无优惠券
