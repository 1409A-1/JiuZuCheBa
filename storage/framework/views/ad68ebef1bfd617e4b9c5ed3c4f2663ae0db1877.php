...
<head>
    ...
    <!--三级联动插件-->
    <script type="text/javascript" src="<?php echo e(asset('admin')); ?>/js/area.js"></script>
            ...
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper products-table section">
                    ...
                    <div class="row-fluid" style="width:100%;">
                        <?php /*<form action="<?php echo e(url('typeIns')); ?>" method="post">*/ ?>
                ...
                <script>
                    $(function(){
                       $("#sub").click(function(){
                        ...
                        she=$("a[href='<?php echo e(url('addrIns')); ?>']");
