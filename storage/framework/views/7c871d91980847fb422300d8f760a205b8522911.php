            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" method="post" action="<?php echo e(URL('typeUpdate')); ?>" />
                                <div class="span12 field-box">
                                    <label>类型:</label>
                                    <input class="span9" type="text" required name="type_name" value="<?php echo e($type['type_name']); ?>" />
                                </div>
                                ...
                                <input type="hidden" name="type_id" value="<?php echo e($type['type_id']); ?>">
