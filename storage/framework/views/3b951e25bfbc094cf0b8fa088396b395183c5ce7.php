    ...
    <div class="book">
        ...
        <div class="bookBody">
            ...
            <div class="shortBox">
                ...
                <form id="fm" method="post" action="<?php echo e(url('short')); ?>" onsubmit="return check();">
            ...
            <div class="setMeal">
                ...
                <div>
                    <div class="sM_L">
                        <b><?php echo e($v['pack_day']); ?></b>天<br>
                        <?php echo e($v['pack_name']); ?>

                    </div>
                    <div class="hr"></div>
                    <div class="sM_R">
                        ￥<a><?php echo e((int)$v['pack_price']); ?></a>
...
<form id="fmtuijian" method="post" action="<?php echo e(url('short')); ?>">
   <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token"/>
   <input id="shop_id" name="shop_id" type="hidden">              <?php /*服务点的id*/ ?>
   <input id="class_id" name="class_id" type="hidden">            <?php /*车辆id*/ ?>
   <input id="StartDateTime" name="StartDateTime" type="hidden">  <?php /*开始时间*/ ?>
   <input id="EndDateTime" name="EndDateTime" type="hidden">      <?php /*结束时间*/ ?>
</form>
